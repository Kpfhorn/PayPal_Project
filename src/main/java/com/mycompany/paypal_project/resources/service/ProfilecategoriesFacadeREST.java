...
public class ProfilecategoriesFacadeREST extends AbstractFacade<Profilecategories> {

    @PersistenceContext(unitName = "my_persistence_unit")
    private EntityManager em;

    public ProfilecategoriesFacadeREST() {
        super(Profilecategories.class);
    }

    @POST
    @Override
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void create(Profilecategories entity) {
        super.create(entity);
    }
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") Integer id, Profilecategories entity) {
        super.edit(entity);
    }
    ...
    public Profilecategories find(@PathParam("id") Integer id) {
    ...
    @Override
    @Produces({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public List<Profilecategories> findAll() {
